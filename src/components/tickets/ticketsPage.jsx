...
class TicketsPage extends Component {
  ...
  confirmationAddTicket = (ticket) => {
    this.setState({ newlyCreatedTicket: ticket });
    const args = {
  ...
  render() {
    const { newlyCreatedTicket } = this.state;
    return (
          ...
          {(matches) =>
            matches ? (
              <div className="media_resolution">
                <div
                  className="ticketsSideMenuMobile"
                  style={{
                    // display: "grid",
                    alignItems: "center",
                ...
                <div className="ticketsTableMobile">
                  {" "}
                  <TicketsList />
                </div>
              </div>
