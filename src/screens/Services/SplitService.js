        ...
        <Container>
          ...
          <Row className="my-5 serviceUserManual">
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 12 }}>
              <h2>دليل الاستخدام (فرز أرض فضاء)</h2>{" "}
              <div style={{ textAlign: "right" }}>
                <a
                  rel="noreferrer"
                  target="_blank"
                  href={`${process.env.PUBLIC_URL}/servicesManual/نظام الفرز الالكتروني (فرز أرض فضاء).pdf`}
                  download
                >
              ...
              <h2>دليل الاستخدام (فرز دوبلكسات)</h2>{" "}
              <div style={{ textAlign: "right" }}>
                <a
                  rel="noreferrer"
                  target="_blank"
                  href={`${process.env.PUBLIC_URL}/servicesManual/نظام الفرز الالكتروني (فرز دوبلكسات).pdf`}
                  download
                >
                  تحميل دليل الاستخدام
                  <FontAwesomeIcon
