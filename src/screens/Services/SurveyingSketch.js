    ...
    <div className="goalsPage">
      ...
      <div className="goalsHeader">
        <div className=" pt-5 pb-3 px-5 mr-lg-5">
          ...
          <span className="span2">خدمات إصدار الكروكي المساحي</span>
          <h1>خدمـات إصـدار الكـروكي المسـاحي</h1>
        </div>
      </div>
        ...
        <Container>
          <Row className="my-5 servicePageHeader">
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 16 }}>
              <h2>نظام خدمات إصدار الكروكي المساحي</h2>
              <p>
                خدمة إلكترونية تتيح للمستفيدين بالتعاون مع المكاتب الهندسية
                المؤهلة من قبل الأمانة، التقدم بطلبات إصدار الكروكي المساحي
                لتنفيذ إجراءات معاملات الكروكي دون الحاجة لزيارة الأمانة أو
                البلدية التابعة ، وتم تطوير تطبيق جغرافي يتمثل في أتمتة معاملات
                إصدار تقارير الكروكي المساحي للأراضي التابعة للمخططات المعتمدة
                من قبل الأمانة
              </p>
            </Col>
            ...
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 12 }}>
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <a
                  rel="noreferrer"
                  target="_blank"
                  href={`${process.env.PUBLIC_URL}/servicesManual/نظام الكروكي المساحي الإلكتروني.pdf`}
                  download
                >
          ...
          <Row className="my-5 serviceUserManual">
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 11 }}>
              <h3>خدمة إصدار كروكي مساحي لأرض مخططة</h3>
              <p>
                إجراء يصدر عنه تقرير الكروكي المساحي لأرض داخل المخططات
                التقسيمية المعتمدة
              </p>
            </Col>{" "}
            <Col md={{ span: 2 }}></Col>
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 11 }}>
              <h3>خدمة إصدار كروكي مساحي لأرض غير مخططة</h3>
              <p>
                إجراء يصدر عنه تقرير الكروكي المساحي لأرض خارج المخططات
                التقسيمية المعتمدة
              </p>
            </Col>
          </Row>
              ...
              <div>
                ...
                <ul>
                  <li>
                    ...
                    المستخدم خدمة إصدار كروكي مساحي لأرض مخططة.
                  </li>
                  <li>يدخل المستخدم بيانات المالك او المستفيد صاحب الطلب.</li>
                  <li>يدخل المستخدم ويحدد بيانات الكروكي.</li>
                  ...
                  <li>ارسال الطلب للمعالجة وإصدار تقرير الكروكي المساحي</li>
                </ul>
              </div>
            </Col>{" "}
            <Col md={{ span: 2 }}></Col>
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 11 }}>
              <div>
                ...
                <ul>
                  <li>
                    بعد تسجيل الدخول على النظام من خلال بوابة الأمانة يختار
                    المستخدم خدمة إصدار كروكي مساحي لأرض غير مخططة.
                  </li>
                  <li> يدخل المستخدم بيانات المالك او المستفيد صاحب الطلب.</li>
                  <li> يدخل المستخدم ويحدد بيانات الكروكي.</li>
                  <li> يدخل المستخدم ويرفق بيانات وثائق الملكية.</li>
                  ...
                  <li>
                    ارسال الطلب للمعالجة وإصدار تقرير الكروكي المساحي واعتماده
                    من اللجنة الفنية
                  </li>
                </ul>
              </div>
