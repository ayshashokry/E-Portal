        ...
        <Container>
          <Row className="my-5 servicePageHeader">
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 16 }}>
              ...
              <p>
                ...
                الاستعراض والاستعلام عن المعلومات الجغرافية التي توفرها أمانة
                المنطقة الشرقية، كما يقدم مجموعة من الخدمات الجغرافية والبلدية
                ...
                الادوات الجغرافية التي يمكن تطويعها في إجراء وتنفيذ استفسارات
                وتحليلات متنوعة اعتمادا على المعلومات المتاحة في قاعدة البيانات
                الجغرافية ، ومن ثم إتاحة تقديم نتائج الاستفسارات والتحليلات
          ...
          <Row className="my-5 serviceUserManual">
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 16 }}>
              ...
              <ul>
                <li>
                  إتاحة توفير البيانات والمعلومات الجغرافية بصورة سهلة وميسرة
                ...
                <li>
                  ...
                  تطبيق نظم المعلومات الجغرافية بشكل فاعل على مستوى مدن المنطقة
                  الشرقية.
                </li>
                <li> تشجيع الاستثمار في مجال التطوير العقاري</li>
                <li>
                  {" "}
                  نشر الوعي بأهمية نظم المعلومات الجغرافية على شبكة الأنترنت
