        ...
        <div className="goals servicePage mb-5 pb-5">
          <Container fluid className="px-lg-4">
            <Form
              ...
              <Row>
                ...
                <Col md={{ span: 3 }} sm={{ span: 24 }} className="px-2 m-auto">
                  <Button onClick={this.Search}>بحث</Button>
                </Col>
              </Row>
            </Form>

            <div style={{ textAlign: "left" }} className="servicePrintBtn">
              {" "}
              <PrintComponents
                trigger={
                  <Button>
                ...
                <Row className="mb-5" style={{ width: "100%" }}>
                  ...
                  <Col span={13} className="text-right mr-4 pt-3 printTitle">
                    <h4>المملكة العربية السعودية</h4>
                    <h6>أمانة المنطقة الشرقية</h6>
                  </Col>
                  <Col span={7} className="text-left mr-4 pt-3 printTitle">
                    <h4>
                      التاريخ : {toArabic(moment().format("iYYYY/iMM/iDD"))}
                    </h4>
                  </Col>
                </Row>
            ...
            {this.state.loading && this.state.tableResult.length === 0 ? (
              ...
              <>
                <div className=" mt-4">
                  <Table className="mt-2 ownerTable engTable" responsive>
                    <thead>
                      <tr>
                        <th className="thNumber">رقم الجوال </th>
                        <th className="thNumber">رقم الهاتف </th>
