...
import EngOfficesApprovalService from "./EngOfficesApprovalService";
import PlansService from "./PlansService";
import UpdateInstrumentsService from "./UpdateInstrumentsService";
import BasemapManagementService from "./SupportService";
...
function ServicePage(props) {
  return (
    <div>
      ...
      ) : props.location.pathname.substring(10) === "EngineeringOffices" ? (
        <EngOfficesApprovalService isAuth={props.isAuth} />
      ...
      )  : props.location.pathname.substring(10) === "support" ? (
        <SupportService isAuth={props.isAuth} />
