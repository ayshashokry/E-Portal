            ...
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 12 }}>
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <a
                  rel="noreferrer"
                  target="_blank"
                  href={`${process.env.PUBLIC_URL}/servicesManual/نظام تحديث الصكوك الإلكتروني.pdf`}
                  download
                >
            ...
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 16 }}>
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>
                    {" "}
                    يدخل المستخدم ويحدد بيانات تحديث الصكوك ويرفق بيانات وثائق
                    الملكية.
                  </li>
                  <li>يدخل المستخدم بيانات الرفع المساحي.</li>
                  <li>
                    {" "}
                    يحدد المستخدم اذا كان يريد اى من الاغراض فى تحديث الصكوك.
                  </li>
